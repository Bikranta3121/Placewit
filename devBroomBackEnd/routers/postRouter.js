...
rtr.get("/", authenticate, async (request, response) => {
  try {
...
/*
    ...
    @access : PRIVATE
 */
rtr.get("/:postId", authenticate, async (request, response) => {
  try {
...
/*
    ...
    @access : PRIVATE
 */
rtr.delete("/:postId", authenticate, async (request, response) => {
  try {
    let postId = request.params.postId;
...
/*
    ...
    @access : PRIVATE
 */
rtr.put("/like/:postId", authenticate, async (request, response) => {
  try {
