...
let DeveloperDetails = () => {
  ...
  const fetchDeveloper = async() =>{
    const {status ,data} = await axios.get(`https://akash-dev-room-b.onrender.com/api/profiles/${developerId}`, {
      headers: {
  ...
  let isfollowingclicked = async() => {
    // console.log(developerId);
     let {data} =await axios.put(`https://akash-dev-room-b.onrender.com/api/profiles/follower/${developerId}`,{},{
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      }
