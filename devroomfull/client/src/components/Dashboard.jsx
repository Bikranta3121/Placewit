...
let Dashboard = () => {
   ...
   const getProfile = async() =>{
    let {status,data} = await axios.get("https://akash-dev-room-b.onrender.com/api/profiles/me",{
      headers: {
  ...
  const getUser =async()=>{
  let { data } = await axios.get("https://akash-dev-room-b.onrender.com/api/users/me", {
   headers: {
     "Content-Type": "application/json",
     Authorization: `Bearer ${localStorage.getItem("devroom")}`,
   },
...
//  console.log(data.user);
 setLoading(false);
  ...
  let clickDeleteExperience = async(experienceId) => {
    const {data} = await axios.delete(`https://akash-dev-room-b.onrender.com/api/profiles/experience/${experienceId}`,{
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let clickDeleteEducation = async(educationId) => {
   const { data } = await axios.delete(
     ` https://akash-dev-room-b.onrender.com/api/profiles/education/${educationId}`,
     {
       headers: {
         "Content-Type": "application/json",
         Authorization: `Bearer ${localStorage.getItem("devroom")}`,
                ...
                <div className="container">
                  <div className="row">
                    ...
                    <div className="d-flex">
                     ...
                     <div className="h5">
                    <div className="text-center">{profile.Follower.length}</div>
                          <div>Follower</div>
                                </div>

                         <div className="ms-4 h5">
                         <div className="text-center">{profile.Following.length}</div>
                         Following 
